...
class PermissionsSetup {
  ...
  static Future<bool> checkCameraPermissions(bool hasCameraPermission, Function(String mess) speak) async{
    ...
    if (!hasCameraPermission) {
      speak("Ứng dụng cần cấp quyền camera để hoạt động vui lòng cấp quyền camera để sử dụng ứng dụng");
      openAppSettings();
    }
  ...
  static Future<bool> checkMicPermissions( bool hasMicPermission, Function(String mess) speak) async{
    ...
    if (!hasMicPermission) {
      speak("Ứng dụng cần cấp quyền microphone để hoạt động vui lòng cấp quyền camera để sử dụng ứng dụng");
      openAppSettings();
    }
